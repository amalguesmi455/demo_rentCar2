        ...
        <tbody>
            ...
            foreach ($voiture as $car): ?> 
                <tr>
                    ...
                    <td><a href="Task.php?action=getCarPhotos&id=<?= $car['id_voiture'] ?>" style="border:1px solid rgb(0, 120, 205); color:rgb(0, 120, 205)">
                photos
            </a></td>
            <td><?= $car['action'] ?></td>
            <td>
                    <a href="Task.php?action=location&id=<?= $car['id_voiture'] ?>" class="btn btn-dark" role="button">LOUER</a> 
