...
<form action="./Task.php?action=edit&id=<?php echo $id ?>" method="POST" class="text-center mt-5" >
<img src="./<?php echo $user['photo_profil'] ;?>" class="img-radius" alt="" width="230" height="250" >
 ...
 <div class="col-sm-6">
   ...
   <input type="text" class="form-control" name="email" placeholder="" required value="">

  </div>
  <div class="col-sm-6">
  <p class="m-b-10 f-w-600">Password :</p></p>
  <h6 class="text-muted f-w-400"    ></h6>
  <input type="text" class="form-control" name="password" placeholder="" required value="">
