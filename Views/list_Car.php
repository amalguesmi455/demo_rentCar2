...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav">
            <li class="nav-item">
                    <a class="nav-link" href="list_Car.php">Rechercher</a>
                </li>
            <li class="nav-item">
    ...
    <table class="table table-striped" id="myTable" class="display">
        ...
        <tbody>
            ...
            foreach ($voiture as $car): ?> 
                <tr>
                    <th scope="row"><?= $car['id_voiture'] ?></th>
                    <td><?= $car['marque'] ?></td>
                    <td><?= $car['modele'] ?></td>
                    <td><?= $car['couleur'] ?></td>
                    <td><?= $car['prix_location'] ?></td>
                    <td><?= $car['date_arrivage'] ?></td>
                    <td>
                     <a href="Task.php?action=getCarPhotos&id=<?= $car['id_voiture'] ?>" style="border:1px solid rgb(0, 120, 205); color:rgb(0, 120, 205)">
                photos
            </a>
        </td>                    <td><?= $car['action'] ?></td>
                    
                    <td>
                    <a href="Task.php?action=editCar&id=<?= $car['id_voiture'] ?>" class="btn btn-success" role="button" >UPDATE</a>
                    
                    <a href="Task.php?action=deleteCar&id=<?= $car['id_voiture'] ?>" class="btn btn-danger" role="button">DELETE</a> 
